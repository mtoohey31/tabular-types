...
theorem _root_.TabularTypes.«F⊗⊕ω».Type.eq_forall_of_TypeVar_open_eq_forall
...
theorem _root_.TabularTypes.«F⊗⊕ω».Type.eq_arr_of_TypeVar_open_eq_arr
...
theorem _root_.TabularTypes.«F⊗⊕ω».Type.eq_unit_of_TypeVar_open_eq_unit
