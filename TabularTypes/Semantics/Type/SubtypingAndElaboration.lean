...
syntax (name := subtyping) Lott.Symbol.TabularTypes.ClassEnvironment "; " Lott.Symbol.TabularTypes.TypeEnvironment " ⊢ " Lott.Symbol.TabularTypes.TypeScheme " <: " Lott.Symbol.TabularTypes.TypeScheme : Lott.Judgement
...
macro_rules
  | `([[$Γc:Lott.Symbol.TabularTypes.ClassEnvironment; $Γ:Lott.Symbol.TabularTypes.TypeEnvironment ⊢ $σ₀:Lott.Symbol.TabularTypes.TypeScheme <: $σ₁:Lott.Symbol.TabularTypes.TypeScheme]]) =>
...
def subtypingTexElab : Lott.TexElab := fun profile ref stx => do
  let `(subtyping| $Γc:Lott.Symbol.TabularTypes.ClassEnvironment; $Γ:Lott.Symbol.TabularTypes.TypeEnvironment ⊢ $σ₀:Lott.Symbol.TabularTypes.TypeScheme <: $σ₁:Lott.Symbol.TabularTypes.TypeScheme) := stx
