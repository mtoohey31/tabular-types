...
syntax (name := rowEquivalence) Lott.Symbol.TabularTypes.ClassEnvironment "; " Lott.Symbol.TabularTypes.TypeEnvironment " ⊢ " Lott.Symbol.TabularTypes.Monotype " ≡" "(" Lott.Symbol.TabularTypes.Monotype ") " Lott.Symbol.TabularTypes.Monotype : Lott.Judgement

macro_rules
  | `([[$Γc:Lott.Symbol.TabularTypes.ClassEnvironment; $Γ:Lott.Symbol.TabularTypes.TypeEnvironment ⊢ $ρ₀:Lott.Symbol.TabularTypes.Monotype ≡($μ:Lott.Symbol.TabularTypes.Monotype) $ρ₁:Lott.Symbol.TabularTypes.Monotype]]) =>
...
def rowEquivalenceTexElab : Lott.TexElab := fun profile ref stx => do
  let `(rowEquivalence| $Γc:Lott.Symbol.TabularTypes.ClassEnvironment; $Γ:Lott.Symbol.TabularTypes.TypeEnvironment ⊢ $ρ₀:Lott.Symbol.TabularTypes.Monotype ≡($μ:Lott.Symbol.TabularTypes.Monotype) $ρ₁:Lott.Symbol.TabularTypes.Monotype) := stx
  ...
  let ρ₀ ← Lott.texElabSymbolOrJudgement `Lott.Symbol.TabularTypes.Monotype profile ref ρ₀
  let μ ← Lott.texElabSymbolOrJudgement `Lott.Symbol.TabularTypes.Monotype profile ref μ
  let ρ₁ ← Lott.texElabSymbolOrJudgement `Lott.Symbol.TabularTypes.Monotype profile ref ρ₁
