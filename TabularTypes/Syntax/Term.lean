...
import TabularTypes.Syntax.ClassEnvironment
...
nonterminal Term, M, «N» :=
  ...
  | M "^^^" a "#" n                     : TypeVar_multi_open notex (id a) (expand := return .mkCApp `TabularTypes.Term.TypeVar_multi_open #[M, a, n]) (tex := M)
  | M "^^^" x "#" n                     : TermVar_multi_open notex (id x) (expand := return .mkCApp `TabularTypes.Term.TermVar_multi_open #[M, x, n]) (tex := M)
