...
⊢ κ₀ ⇝ K₀
⊢ κ₁ ⇝ K₁
Eₚ := Λ a' : K₁ ↦ *. ⦅π 0 E⦆ [λ a : K₀. a'$1 A]
Eᵢ := Λ a' : K₁ ↦ *. ⦅π 1 E⦆ [λ a : K₀. a'$1 A]
...
⊢ κ₀ ⇝ K₀
⊢ κ₁ ⇝ K₁
Eₙ := Λ a' : K₁ ↦ *. ⦅π 0 E⦆ [λ a : K₀. a'$1 A]
Eₑ := Λ a' : K₁ ↦ *. ⦅π 1 E⦆ [λ a : K₀. a'$1 A]
Eₗ := (Λ a' : K₁ ↦ *. ⦅π 0 π 2 E⦆ [λ a : K₀. a'$1 A], Λ a' : K₁ ↦ *. ⦅π 1 π 2 E⦆ [λ a : K₀. a'$1 A])
Eᵣ := (Λ a' : K₁ ↦ *. ⦅π 0 π 3 E⦆ [λ a : K₀. a'$1 A], Λ a' : K₁ ↦ *. ⦅π 1 π 3 E⦆ [λ a : K₀. a'$1 A])
...
E := Λ aₘ : (L K) ↦ *. λ xₛ : Aₛ. λ xᵢ : aₘ$0 { }. E'
─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── ind (comment := "where the comprehension in $\\targetpre E' \\targetpost$ is repeated application") (I₀ I₁ : List TypeVarId)
