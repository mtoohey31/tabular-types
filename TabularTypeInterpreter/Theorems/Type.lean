...
theorem deterministic (σke₀ : [[Γc; Γ ⊢ σ : κ₀ ⇝ A]])
  ...
  | .row ξ₀ke _ τ₀ke h (n := n), σke₁ => by
    let ⟨_, _, ⟨_, _, Aeq, κeq, κ'eq, τ₁ke⟩⟩ := σke₁.row_inversion (n := n)
    cases κeq
    cases Aeq
...
decreasing_by
  all_goals simp_arith
  · case _ ξ _ τ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ =>
